...
public class Leaderboard extends World
{
    ...
    private void createBackground()
    {
        ...
        TextBox textBox1 = new TextBox( " LEADERBOARD ", 50, true, Color.WHITE, Color.BLACK );
        ...
        TextBox header2 = new TextBox(" Easy ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(header2, getWidth() / 2 + 220, getHeight() / 2 - 110);
        
        /**
         * easy leaderboard
         */
        TextBox textBox2 = new TextBox( " 1 ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox2, getWidth() / 2 - offset1, getHeight() / 2 - 50);
        TextBox textBox3 = new TextBox( " 2 ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox3, getWidth() / 2 - offset1, getHeight() / 2);
        TextBox textBox4 = new TextBox( " 3 ", 40, true, Color.WHITE, new Color(0,153,0));
        ...
        showText("null", getWidth() / 2 - offset2, getHeight() / 2 - 50);
        showText("null", getWidth() / 2 - offset2, getHeight() / 2);
        showText("null", getWidth() / 2 - offset2, getHeight() / 2 + 50);
        showText("null", getWidth() / 2 - offset2, getHeight() / 2 + 100);
        showText("null", getWidth() / 2 - offset2, getHeight() / 2 + 150);
        
        TextBox textBox7 = new TextBox( " Level: " + easy1lvl + " ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox7, getWidth() / 2 - offset3, getHeight() / 2 - 50);
        TextBox textBox8 = new TextBox( " Level: " + easy2lvl + " ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox8, getWidth() / 2 - offset3, getHeight() / 2);
        TextBox textBox9 = new TextBox( " Level: " + easy3lvl + " ", 40, true, Color.WHITE, new Color(0,153,0));
         ...
         * normal leaderboard
         */
        TextBox textBox12 = new TextBox( " 1 ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox12, getWidth() / 2 + offset4, getHeight() / 2 - 50);
        TextBox textBox13 = new TextBox( " 2 ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox13, getWidth() / 2 + offset4, getHeight() / 2);
        TextBox textBox14 = new TextBox( " 3 ", 40, true, Color.WHITE, new Color(0,153,0));
        ...
        showText("null", getWidth() / 2 + offset5, getHeight() / 2 - 50);
        showText("null", getWidth() / 2 + offset5, getHeight() / 2);
        showText("null", getWidth() / 2 + offset5, getHeight() / 2 + 50);
        showText("null", getWidth() / 2 + offset5, getHeight() / 2 + 100);
        showText("null", getWidth() / 2 + offset5, getHeight() / 2 + 150);
        
        TextBox textBox17 = new TextBox( " Level: " + easy1lvl + " ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox17, getWidth() / 2 + offset6, getHeight() / 2 - 50);
        TextBox textBox18 = new TextBox( " Level: " + easy2lvl + " ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox18, getWidth() / 2 + offset6, getHeight() / 2);
        TextBox textBox19 = new TextBox( " Level: " + easy3lvl + " ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox19, getWidth() / 2 + offset6, getHeight() / 2 + 50);
        TextBox textBox20 = new TextBox( " Level: " + easy4lvl + " ", 40, true, Color.WHITE, new Color(0,153,0));
        addObject(textBox20, getWidth() / 2 + offset6, getHeight() / 2 + 100);
        TextBox textBox21 = new TextBox( " Level: " + easy5lvl + " ", 40, true, Color.WHITE, new Color(0,153,0));
